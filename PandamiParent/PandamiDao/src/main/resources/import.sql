...
INSERT INTO `pandami_db`.`user` (`id`, `birthDate`, `email`, `emergencyContactName`, `emergencyContactPhoneNumber`, `emergencyContactSurname`, `inscriptionDate`, `login`, `name`, `password`, `phoneNumber`, `street`, `surname`, `city_id`, `gender_id`) VALUES ('5', '1988-02-20 00:00:00', 'ytzdizjaid@hotmail.fr', 'taty', '0145959562', 'taty', '2016-05-05 00:00:00', 'taty', 'taty', 'taty', '0688989289', '21 Rue Gabriel Péri', 'taty', '5', '1', '2');
