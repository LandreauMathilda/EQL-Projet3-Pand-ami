...
INSERT INTO `pandami_db`.`equipment_type` (`id`, `label`) VALUES ('1', 'Outils de bricolage');
INSERT INTO `pandami_db`.`equipment_type` (`id`, `label`) VALUES ('2', 'Outils de jardinage');
INSERT INTO `pandami_db`.`equipment_type` (`id`, `label`) VALUES ('3', 'Produits ménagers');
INSERT INTO `pandami_db`.`equipment_type` (`id`, `label`) VALUES ('4', 'Voiture');
INSERT INTO `pandami_db`.`equipment_type` (`id`, `label`) VALUES ('5', 'Ordinateur');
...
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`) VALUES ('1', 'Garde d\'enfant', '1');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`) VALUES ('2', 'Accompagnement scolaire', '1');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`, `equipmentType_id`) VALUES ('3', 'Aide administrative', '1', '5');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`) VALUES ('4', 'Courses essentielles', '2');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`) VALUES ('5', 'Livraison médicaments', '2');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`, `equipmentType_id`) VALUES ('6', 'Jardinage', '3', '2');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`, `equipmentType_id`) VALUES ('7', 'Bricolage', '3', '1');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`, `equipmentType_id`) VALUES ('8', 'Ménage', '3', '3');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`) VALUES ('9', 'Compagnie', '4');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`) VALUES ('10', 'Promenade', '4');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`, `equipmentType_id`) VALUES ('11', 'Rendez-vous médical', '5', '4');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`, `equipmentType_id`) VALUES ('12', 'Rendez-vous administratif', '5', '4');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`, `equipmentType_id`) VALUES ('13', 'Lieux de culte', '5', '4');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`) VALUES ('14', 'Garde animaux', '6');
INSERT INTO `pandami_db`.`activity` (`id`, `label`, `activityCategory_id`) VALUES ('15', 'Promenade animal', '6');
...
INSERT INTO `pandami_db`.`demand` (`id`, `actionDate`, `endHour`, `publishDate`, `startHour`, `street`, `activity_id`, `city_id`, `user_id`) VALUES ('15', '2021-03-14', '14:00:00', '2021-03-11', '12:00:00', '21 Rue Gabriel Péri', '10', '5', '5');
