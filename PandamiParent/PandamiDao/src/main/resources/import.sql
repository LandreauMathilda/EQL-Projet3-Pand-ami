...
INSERT INTO `pandami_db`.`user` (`id`, `birthDate`, `email`, `emergencyContactName`, `emergencyContactPhoneNumber`, `emergencyContactSurname`, `inscriptionDate`, `login`, `name`, `password`, `phoneNumber`, `street`, `surname`, `city_id`, `gender_id`, `userType_id`) VALUES ('1', '442-11-29', 'arthurPendragon@Kaamelott.fr', 'Guenièvre', '0146632542', 'Pendragon', '2015-03-04 14:25:00', 'arthur', 'Arthur', 'arthur', '0642648659', '4 Boulevard de Créteil', 'Pendragon', '1', '1', '1');
INSERT INTO `pandami_db`.`user` (`id`, `birthDate`, `email`, `emergencyContactName`, `emergencyContactPhoneNumber`, `emergencyContactSurname`, `inscriptionDate`, `login`, `name`, `password`, `phoneNumber`, `street`, `surname`, `city_id`, `gender_id`, `userType_id`) VALUES ('2', '436-02-14', 'guenievrePendragon@Kaamelott.fr', 'Léodagan', '0126743285', 'De Carmélide', '2015-04-25 11:23:00', 'guenievre', 'Guenièvre', 'guenievre', '0674812961', '50 Boulevard Maxime Gorki', 'Pendragon', '2', '2', '2');
INSERT INTO `pandami_db`.`user` (`id`, `birthDate`, `email`, `emergencyContactName`, `emergencyContactPhoneNumber`, `emergencyContactSurname`, `inscriptionDate`, `login`, `name`, `password`, `phoneNumber`, `street`, `surname`, `city_id`, `gender_id`, `userType_id`) VALUES ('3', '450-08-18', 'percevalDeGalles@Kaamelott.fr', 'Angharad', '0624421819', 'Aux Mains d’Or ', '2017-07-02 16:42:00', 'perceval', 'Perceval', 'perceval', '0624796582', '73 Avenue Maurice Thorez', 'De Galles', '3', '1', '2');
INSERT INTO `pandami_db`.`user` (`id`, `birthDate`, `email`, `inscriptionDate`, `login`, `name`, `password`, `phoneNumber`, `street`, `surname`, `city_id`, `gender_id`, `userType_id`) VALUES ('4', '445-10-03', 'angharadAuxMainsDOr@Kaamelott.fr', '2018-07-26 13:12:00', 'angharad', 'Angharad', 'angharad', '0624421819', '4 Rue Diderot', 'Aux Mains d’Or ', '4', '2', '2');
INSERT INTO `pandami_db`.`user` (`id`, `birthDate`, `email`, `emergencyContactName`, `emergencyContactPhoneNumber`, `emergencyContactSurname`, `inscriptionDate`, `login`, `name`, `password`, `phoneNumber`, `street`, `surname`, `city_id`, `gender_id`, `userType_id`) VALUES ('5', '443-06-04', 'lancelotDuLac@Kaamelott.fr', 'Bohort', '0695784312', 'De Gaunes', '2020-03-14 09:26:00', 'lancelot', 'Lancelot', 'lancelot', '0146341816', '21 Rue Gabriel Péri', 'Du Lac', '5', '1', '2');
